...
import 'package:e_store/common/widgets/products/ratings/rating_bar_indicator.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        const SizedBox(height: ESizes.spaceBtwItems),
        const ReadMoreText(
          'The user interface of the app is quite intuitive. I was able to navigate and make purchases seamlessly. Great job! I hope we can saw some great feature in this app soon.',
          trimLines: 2,
